...
public class MiesozercaTest {
    ...
    public void testZadajObrazenia_Wszystkożerca() {
        Wszystkozerca wszystkożerca = new Wszystkozerca();
        wszystkożerca.x = 1;
        wszystkożerca.y = 1;
